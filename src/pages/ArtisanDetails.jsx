    ...
    <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
            ...
            <a href="#"
                ...
                <img src={artisan.images.image1} loading="lazy" alt="Photo by Minh Pham" className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
            ...
            <a href="#"
                ...
                loading="lazy" alt="Photo by Magicle" className="absolute inset-0 h-full w-full object-cover object-center transition duration-200 group-hover:scale-110" />
