...
function Registration(props) {
    ...
    return (
        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <img className="mx-auto w-20 h-20 w-auto bg-black rounded-full" src={img} alt="Workflow" />
                  ...
                  <div className="flex justify-center">
                    <div className="mt-1 relative rounded-md ">
                      <FormikControl
                        ...
                        className="appearance-none block w-80 justify-center px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5"
                      />
                  ...
                  <div className="mt-6">
                    <div className=" flex ml-6 mt-1 rounded-md ">
                      ...
                      <div className="flex items-center text-center justify-center p-2 " onClick={()=> setVisible(!visible)}> 
                          {
                            visible ?  <i className="fas fa-eye text-gray-300"></i> : <i className="fas fa-eye-slash text-gray-300"></i>
                          }
                        </div>
                    </div>
                  </div>
                  ...
                  <div className=" mt-2 ">
                    <span className="block w-80 rounded-md ">
                      <button
                        ...
                        className="ml-6 w-80 py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-purple-500 hover:bg-purple-800 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700 transition duration-150 ease-in-out"
                      >
                          Register
                      </button>
                    </span>
