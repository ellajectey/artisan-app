        ...
        <div className="flex-1 flex flex-col">
          ...
          <nav className="flex-none flex justify-between bg-white h-16">
            ...
            <ul className="px-8 flex items-center">
              ...
              <div className="flex rounded-full bg-orange-300 w-10 h-10 px-4 py-4 mx-4 ml-20 justify-center">
                <span className="flex font-semibold text-center">RA</span>
              </div>
          ...
          <section className="w-full overflow-hidden mb-4">
            ...
            <img src={nodata} className=" h-50 w-40 " />
            <br/>
              <div>
