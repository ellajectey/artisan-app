                    ...
                    <div className="mt-6">
                      <span className=" flex justify-center w-full rounded-md ">
                        <button
                          ...
                          className="w-80 flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-orange-500 hover:bg-orange-800 focus:outline-none focus:border-orange-700 focus:shadow-outline-orange active:bg-orange-300 transition duration-150 ease-in-out"
                        >
                          Sign in
                        </button>
                      </span>
