            ...
            <div class="max-w-sm w-full shadow-lg">
                <div class="md:p-8 p-5 dark:bg-gray-800 bg-white rounded-t">
                    <div class="px-4 flex items-center justify-between">
                        <span  tabindex="0" class="focus:outline-none  text-base font-bold dark:text-gray-100 text-gray-800">April 2024</span>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="w-full h-full">
                                            <div class="flex items-center justify-center w-full rounded-full cursor-pointer">
                                                <a  role="link" tabindex="0" class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-gray-700 focus:bg-gray-500 hover:bg-gray-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-gray-700 rounded-full">8</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="px-2 py-2 cursor-pointer flex w-full justify-center">
                                            <p class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-orange-700 focus:bg-orange-500 text-base text-gray-500 dark:text-gray-100 font-medium text-white bg-orange-400 rounded-full px-1">28</p>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="px-2 py-2 cursor-pointer flex w-full justify-center">
                                            <p class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-orange-700 focus:bg-orange-500 text-base text-gray-500 dark:text-gray-100 font-medium text-white bg-orange-400 rounded-full px-1">29</p>
                                        </div>
                                    </td>
                                    <td>
                                        <div class="px-2 py-2 cursor-pointer flex w-full justify-center">
                                            <p class="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-orange-700 focus:bg-orange-500 text-base text-gray-500 dark:text-gray-100 font-medium text-white bg-orange-600 rounded-full px-1">30</p>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
                ...
                <div class="md:py-8 py-5 md:px-16 px-5 dark:bg-gray-700 bg-gray-50 rounded-b">
                    <div class="px-4">
                        <div class="border-b pb-4 border-gray-400 border-dashed">
                            <p class="text-xs font-light leading-3 text-gray-500 dark:text-gray-300">28th April,2024</p>
                            <a tabindex="0" class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Location: Sniit Flats</a>
                            <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Click to view more</p>
                        </div>
                        <div class="border-b pb-4 border-gray-400 border-dashed pt-5">
                            <p class="text-xs font-light leading-3 text-gray-500 dark:text-gray-300">29th April,2024</p>
                            <a tabindex="0" class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Location: Adenta Commandos</a>
                            <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Click to view more</p>

                        </div>
                        <div class="border-b pb-4 border-gray-400 border-dashed pt-5">
                            <p class="text-xs font-light leading-3 text-gray-500 dark:text-gray-300">30th April, 2024</p>
                            <a tabindex="0" class="focus:outline-none text-lg font-medium leading-5 text-gray-800 dark:text-gray-100 mt-2">Location: Victory Presby Church </a>
                            <p class="text-sm pt-2 leading-4 leading-none text-gray-600 dark:text-gray-300">Click to view more</p>
                        </div>   
                    </div>
                </div>
