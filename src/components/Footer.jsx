...
import img from "../assets/artisched-orange-nobg.png";
...
function Footer(props) {
    return (
        <div className='bg-black'>
            ...
            <div className="bg-orange-200 pt-2">
                <div className="flex pb-2 px-3 m-auto pt-2 border-t text-gray-800 text-sm flex-col max-w-screen-lg items-center">
                    ...
                    <p >© Copyright 2020. All Rights Reserved.</p>
                        <a href="/#" className="w-6 mx-1">
                            <svg className="fill-current cursor-pointer text-gray-500 hover:text-orange-600" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" style={{ fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 2 }}>
