...
function MessageCard(props) {
    return (
        <div class="flex flex-col h-screen max-w-sm border border-gray-200 rounded-lg mx-auto my-10 mt-10 px-4 shadow rounded">
    <div class="flex-grow overflow-y-auto">
        ...
        <div class="flex flex-col mb-4 gap-4 py-4">
            ...
            <div class="flex justify-end">
                <div class="bg-orange-500 rounded-lg px-4 py-2 max-w-[80%]">
    ...
    <div class="flex justify-center items-center h-16">
        ...
        <button class="bg-orange-600 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded">Send</button>
    </div>
</div>
    );
}
