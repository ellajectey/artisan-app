  ...
  return (
    <div>
      <section className="relative overflow-hidden bg-purple-200 dark:bg-gray-900">
        ...
        <h2 id="process" className="text-center text-purple-400 font-bold text-2xl">Our Process</h2>
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
            ...
            <div className="relative mt-8 lg:mt-8">
              ...
              <div className="relative grid grid-cols-1 text-center gap-y-8 sm:gap-y-10 md:gap-y-12 md:grid-cols-3 gap-x-12">
                <div>
                  <div className="flex items-center justify-center w-16 h-16 mx-auto bg-white dark:bg-purple-800 border-2 border-purple-400 dark:border-gray-700 rounded-full shadow">
                    <span className="text-xl font-semibold text-purple-700 dark:text-purple-200">
                      1
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex items-center justify-center w-16 h-16 mx-auto bg-white dark:bg-gray-800 border-2 border-purple-400 dark:border-gray-700 rounded-full shadow">
                    <span className="text-xl font-semibold text-purple-700 dark:text-purple-200">
                      2
                    </span>
                  </div>
